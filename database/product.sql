...
CREATE TABLE `product` (
  ...
  `pictures_slideshow` text COMMENT 'picture slideshow',
  `thumbnail` text COMMENT 'thumbnail for homepage',
  `thumbnails_slideshow` text COMMENT 'thumbnail for slideshow',
  PRIMARY KEY (`id`),
