...
insert  into `m_category`(`id`,`name_en`,`name_zh`,`parent_id`,`status`) values (11,'Dell','Dell',0,1),(13,'testing','testing',11,0);
...
insert  into `market`(`id`,`title_en`,`title_zh`,`created_date`,`modify_date`,`desc_en`,`desc_zh`,`province_id`,`district_id`,`image`,`amount_stair`) values (5,'Sovanna','Sovanna','2014-10-25',NULL,'this is Sovanna','This is sovanna',68,68,'1414227058.jpg',NULL),(6,'AEN','AEN','2014-10-25',NULL,'AEN','AEN',166,166,'1414236513.jpg',NULL),(7,'dgfd','dgf','2014-10-25','2014-10-25','dgf','dgf',2,166,'1414237452.jpg','12');
...
insert  into `store`(`id`,`user_id`,`sup_id`,`title_en`,`title_zh`,`desc_en`,`desc_zh`,`view`,`stair`,`image`) values (3,NULL,5,'tests-updated','tests-updated','tests-updated','tests-updated',NULL,'123','1414236398.jpg'),(4,NULL,6,'Store1','sdd','SF','SFS',NULL,'23','1414236547.jpg');
