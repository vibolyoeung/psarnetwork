...
CREATE TABLE `account_role` (
  `rol_id` int(50) NOT NULL AUTO_INCREMENT,
...
/*Table structure for table `account_role_taxonomy` */

DROP TABLE IF EXISTS `account_role_taxonomy`;

CREATE TABLE `account_role_taxonomy` (
  `rol_tax_id` int(11) NOT NULL AUTO_INCREMENT,
  `rol_id` int(11) DEFAULT NULL,
  `acc_type_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rol_tax_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `account_role_taxonomy` */
...
insert  into `product_condiction`(`id`,`name`) values (1,'New Arrival'),(2,'New'),(3,'Second Hand'),(4,'Repaired'),(5,'Old'),(6,'Broken');
