...
insert  into `slideshow`(`id`,`title`,`image`,`short_desc`,`description`,`link_url`,`status`,`product_id`,`advertiser_id`,`created_date`,`expire_date`) values (6,'title-updated','1413631121.jpg','title-updated','title-updated','http://psarnetwork.local/admin/create_slideshow-title-updated',1,NULL,3,'17/11/2014','14/11/2014'),(7,'New Care Arrival','1415712839.png','This is the best time for me This is the best time for me This is the best time for me This is the best time for me This is the best time for me','This is the best time for me This is the best time for me This is the best time for me This is the best time for me This is the best time for me','http://psarnetwork.local/admin/create_slideshow-updated',1,NULL,NULL,'06/11/2014','28/11/2014');
...
insert  into `user`(`id`,`name`,`email`,`password`,`password_temp`,`status`,`create_at`,`update_at`,`remember_token`,`user_type`,`account_type`,`client_type`) values (2,'KOCH Doeun','doeunkoch@gmail.com','$2y$10$gBGqu4Jo/dHIrusgJILwxOCvwT/dAS/91AaifWz38wtD7SecUOO/q',NULL,1,NULL,NULL,'DPadTF8KJ3TkqTa78BG4LYJK6laPBDxr5LSu8p9NtyI2z2CND6udCIR0xOQj',1,NULL,NULL),(3,'HOM Kimhim-updated','kimhim.hom-updated@gmail.com','$2y$10$RY3WZxvzq9K4X/4ZGdQP.uj.usxhCXU2vmhYcC6SXuX/irnlmiJum',NULL,1,NULL,'2014-10-13','',1,NULL,NULL);
...
insert  into `user_type`(`id`,`name`,`permission`) values (1,'Observer ',NULL),(2,'Supervisor',NULL),(3,'Watcher',NULL),(4,'client',NULL),(7,'Operator','a:2:{s:6:\"access\";a:2:{i:0;s:21:\"admin/change-password\";i:1;s:13:\"admin/profile\";}s:6:\"modify\";a:1:{i:0;s:21:\"admin/change-password\";}}');
