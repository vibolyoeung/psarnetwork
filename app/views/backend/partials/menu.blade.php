...
<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
	<ul class="nav navbar-nav">
		<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<li><a href="{{URL::to('admin/front-end-setting')}}">Front-end Setting</a></li>
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle"
		 ...
		 <li class="dropdown">
			...
			<ul class="dropdown-menu">
				<li><a href="{{URL::to('admin/products/free')}}">Free Product</a></li>
				<li><a href="{{URL::to('admin/products/premium')}}">Enterprise Product</a></li>
