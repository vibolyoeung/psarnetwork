          ...
          @if(!empty($banner))
            ...
            @if(count($topSlideShowArr)<1)
            	<div class="item active">
					<a class="banner-link" href="{{Config::get('app.url')}}member/userinfo/slideshow"><img
						src="https://placeholdit.imgix.net/~text?txtsize=60&txt=[1]+750+x+200&w=750&h=200"
						style="width: 100%; max-height: 250px;" /></a>
					<div class="carousel-caption"><a class="banner-link" href="{{Config::get('app.url')}}member/userinfo/slideshow">add slidehow</a></div>
				</div>
				<div class="item">
					<a class="banner-link" href="{{Config::get('app.url')}}member/userinfo/slideshow"><img
