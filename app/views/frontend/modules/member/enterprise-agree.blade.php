							...
							<div class="form-horizontal">
								...
								<div class="col-sm-6">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<input type="file" name="PageBanner" class="form-control" id="PageBanner" placeholder="{{trans('register.agree_head_banner')}}" aria-describedby="PageTitleStatus" required />
										</div>
									</div>
								</div>
							</div>
