			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group col-md-6 col-sm-6 col-xs-6">
						...
						{{ Form::select('district_id',$districts, $mk->district_id , array('class' => 'form-control', 'id' => 'district_option'))}}
						<span class="class-error">{{$errors->first('district_id')}}</span>
					</div>

					<div class="form-group col-md-6 col-sm-6 col-xs-6">
						<label>Description En</label>
						{{ Form::textarea('desc_en',$mk->desc_en, array('class' => 'form-control'))}}
					</div>

					<div class="form-group col-md-6 col-sm-6 col-xs-6">
						<label>Description Zh</label>
						{{ Form::textarea('desc_zh',$mk->desc_zh, array('class' => 'form-control'))}}
					</div>
